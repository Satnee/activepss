...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li><a href="login.aspx">About</a></li>
					<li><a href="login.aspx">Services</a></li>
					<li><a href="login.aspx">Price</a></li>
					<li><a href="login.aspx">Projects</a></li>
					
					<li><a href="login.aspx">Contact</a></li>   
                                   
                    <li class="form-group">
                        <a href="login.aspx" class="btn btnsearch">Login</a>
                    </li>
  ...
  <section id="packages" class="secpadding">
    ...
    <script src="login/js/sweetalert2.js"></script>
